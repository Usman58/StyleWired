...
function FifthCreateOrderScreen() {
        ...
        <Grid item xs={12} md={5}>
          ...
          <Form>
            ...
            <Button
              ...
              style={{ width: "100%" ,backgroundColor:'#585858'}}
            >
              Book your flight
            </Button>
            ...
            <Button
              className={classes.card_btn} component={Link} to="/checkout"
              variant="contained"
              color="success"
              style={{ width: "100%" }}
            >
...
export default FifthCreateOrderScreen;
