...
import image4 from "../images/ICWWIW.png";
import image5 from "../images/WDBNF.png";
import image6 from "../images/EaDU.png";
import image7 from "../images/FUS.png";
...
const GData = [
  ...
  },
  {
    id:2,
    image:image5,
    title:'Well dressed but not too formal',
  ...
  return (
    <>
      <Grid container textAlign="center" >
        <Grid item sm={12}>
          <h4 style={{ color: "#194B2D" }}>When It’s Work Time, When Do You Usually<br />Wear?</h4>
          <p style={{ color: "#848484" }}>Because it can truly vary, what’s your pick? </p>
          ...
          <br />
          <Button className={classes.card_btn} component={Link} to="/anyfashion"
            variant="contained"
            color="success"
            size="large"
            style={{ width: "31%" }}
