...
function FourthCreateOrderScreen() {
    ...
    <>
      <Grid container px={2} spacing={8}>
        <Grid item xs={12} md={5}>
          <h4 style={{ color: "green" }}>Complete your Special Order</h4>
          <p style={{ color: "#848484" }}>
          Fill us with all your travel details so we can get your
            <br />
          ...
          <Form>
            ...
            <Form.Group controlId="name">
              ...
              <Form.Control size="lg" placeholder="Enter your Flight Number" style={{fontSize:'15px'}} >
            ...
            <Button
              className={classes.card_btn} component={Link} to="/ficreateorder"
              variant="contained"
              color="success"
              style={{ width: "100%" }}
            >
...
export default FourthCreateOrderScreen;
