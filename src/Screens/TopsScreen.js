...
import $ from "jquery";
import img1 from "../images/Group 105.png";
import img2 from "../images/image 5 (1).png";
import img3 from "../images/Group 106.png";
    ...
    <>
      <Grid container>
        <Grid item  lg={6} xs={7} p={6}>
          <h4 style={{ color: "#194B2D" }}>What Top Style Is Your Desire?</h4>
        ...
        <Grid container  spacing={2} textAlign="center">
          ...
          <Grid item sm={8} md={4} >
            ...
            >
              <Card.Img src={img1}  />
              <Card.Body>
                <Card.Title style={{fontSize:'15px'}}>Fitted</Card.Title>
              </Card.Body>
            </Card>
          </Grid>
          <Grid item sm={8} md={4}>
            ...
            >
              <Card.Img src={img2} />
              <Card.Body >
                <Card.Title  style={{fontSize:'15px'}}>Straight</Card.Title>
              </Card.Body>
            </Card>
          </Grid>
          <Grid item sm={8} md={4} >
        ...
        <Button variant="contained" color="success" className={classes.card_btn} component={Link} to="/bottomstyle">
        Next
              </Button>
       
        </Grid>
        <Grid item lg={6} xs={5} mt={5}>
